        ...
        <RouterLink :to="{name: 'weathertime', params:{id:weather.id}}">
            <div class="w-[500px] flex flex-wrap shadow-[0_0_10px] rounded-[20px] p-3 bg-[#ffffff35] backdrop-blur-[10px] phone:w-[100%] phone:justify-between ">
              <div class="w-[300px] phone:w-[230px]">
                  <h3 class="text-[25px] mb-[30px] text-[#252525] phone:mb-[20px] myphone:text-[20px] myphone:font-medium">{{ weather.name }}</h3>
              ...
              <div class="flex justify-center items-center">
                  <img :src="`https://openweathermap.org/img/wn/${weather.weather[0].icon}@2x.png`" class="w-[150px] phone:w-[120px] myphone:w-[110px]" alt="Weather icon">
              </div>
